        ...
        >
          ...
          {phase === 'playing' && (
            <>
              ...
              {showHint && (
                <div className="absolute left-1/2 top-20 -translate-x-1/2 z-30 pointer-events-none">
                  <div className="animate-fade-in flex items-center gap-2.5 rounded-2xl border border-fuchsia-300/70 bg-fuchsia-500/30 px-5 py-3 shadow-xl shadow-fuchsia-500/30 backdrop-blur-md">
          ...
          {phase === 'gameover' && (
            <div className="absolute inset-0 flex items-center justify-center bg-game-dark/80 backdrop-blur-sm">
              <div className="text-center max-w-sm px-6">
                ...
                <GameOverActions onMenu={onBack!} onReplay={handleStart} onOpenBoosts={() => setPhase('menu')} onRevive={handleRevive} score={score} mode="classic" />
              </div>
            </div>
          )}
        </div>
